  ...
  <section id="${GUIDE_ID}" class="moca-guide" aria-label="CAFE MOCA 부스 운영 설명">
    <div class="moca-guide__head">
      <div>
        ...
        <h2>부스 운영 설명</h2>
        <p>운영진 3명이 순서대로 참여자를 이어받아 안내합니다.</p>
        <p class="moca-guide__supplies"><strong>공통 준비물</strong> · 각자 아이패드 · 보조배터리 · 노트북</p>
      </div>
    ...
    <div class="moca-guide__grid">
      <article class="moca-guide__card">
        <div class="moca-guide__role">
          ...
          <div>
            <span>입구 담당</span>
            <h3>팝업 소개 · 학번 확인 · 영수증 전달</h3>
          </div>
        </div>
        <ol>
          <li>CAFE MOCA가 <strong>나의 카페 취향을 찾아보는 팝업</strong>임을 간단히 소개합니다.</li>
          <li>학번을 조회해 온라인 참여 여부와 카페 유형을 확인합니다.</li>
          <li>참여 완료자에게 유형에 맞는 영수증을 전달한 뒤 오프라인 게임으로 안내합니다.</li>
          <li>온라인 기록이 없으면 온라인 설문을 먼저 참여하도록 안내합니다.</li>
        </ol>
      ...
      <article class="moca-guide__card">
        ...
        <ol>
          ...
          <li>화면 안내에 따라 키워드 게임을 마지막 완료 화면까지 진행하도록 안내합니다.</li>
          <li>게임 완료 후 협찬 QR 참여 방법을 안내합니다.</li>
          <li><strong>협찬 브랜드에 많은 관심</strong>과 <strong>CAFE MOCA 인스타그램 팔로우</strong>도 함께 부탁드립니다.</li>
        </ol>
        <div class="moca-guide__script">
          <span>게임 안내 멘트</span>
      ...
      <article class="moca-guide__card">
        <div class="moca-guide__role">
          ...
          <div>
            <span>마무리 담당</span>
            <h3>협찬 확인 · 럭키드로우 · 최종 전달</h3>
          </div>
        </div>
        <ol>
          <li>협찬 참여 <strong>완료 화면을 직접 확인</strong>합니다.</li>
          <li>확인 후 본인 학번을 입력해 럭키드로우를 진행하도록 안내합니다.</li>
          <li>럭키드로우는 <strong>학번당 1회</strong>만 참여할 수 있도록 확인합니다.</li>
          <li>결과 확인 후 <strong>럭키드로우 경품 + 미리 포장한 협찬품</strong>을 한 번에 전달하고 참여를 마무리합니다.</li>
        </ol>
        <div class="moca-guide__script">
          <span>협찬 확인 후</span>
